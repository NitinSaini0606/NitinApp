  ...
  return (
    ...
    <div className="min-h-screen bg-[#f8f2e9] flex items-center justify-center p-4">
      <div className="bg-[#fff8e7] shadow-2xl rounded-2xl w-full max-w-md p-8">
        <h1 className="text-3xl font-bold text-[#5c6a4f] text-center mb-6">TaskNest Signup</h1>
        <form 
        className="space-y-4"
        ...
        >
          <div className="flex gap-3">
            <input
              ...
              className="w-1/2 p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#d9822b]"
            />
            <input
              type="text"
              name="lastName"
